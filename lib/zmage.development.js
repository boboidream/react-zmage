...
var defType = {
  ...
  // 是否直接进入 zoomIn
  directZoom: external_prop_types_default.a.bool,
...
var utils_touchStyle = {
  html: {},
  body: {}
};
var lockTouchInteraction = function lockTouchInteraction() {
  // Save
  utils_touchStyle.html.overflow = document.documentElement.style.overflow;
  utils_touchStyle.body.overflow = document.body.style.overflow;
  utils_touchStyle.body.position = document.body.style.position; // Apply
...
var unlockTouchInteraction = function unlockTouchInteraction() {
  // Recover
  document.documentElement.style.overflow = utils_touchStyle.html.overflow;
  document.body.style.overflow = utils_touchStyle.body.overflow;
  document.body.style.position = utils_touchStyle.body.position;
};
/**
...
var withToggleStatus = function withToggleStatus(defClassName) {
  var flag = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var attach = arguments.length > 2 ? arguments[2] : undefined;
  return flag && attach ? "".concat(defClassName, " ").concat(attach) : defClassName;
};
/**
 * 检查图片是否完全载入
...
var mirrorRange = external_lodash_memoize_default()(function (edge) {
  return [].concat(_toConsumableArray(_toConsumableArray(Array(edge).keys()).map(function (k) {
    return -k - 1;
  }).reverse()), _toConsumableArray(Array(edge + 1).keys()));
});
...
function (_React$PureComponent) {
  ...
  function Control() {
    ...
    Control_defineProperty(Control_assertThisInitialized(_this), "withShow", function (className) {
      ...
      return withToggleStatus(className, !zoom && show, Control_default.a.show);
    });

    Control_defineProperty(Control_assertThisInitialized(_this), "withMobile", function (className) {
      var presetIsMobile = _this.context.presetIsMobile;
      return withToggleStatus(className, presetIsMobile, Control_default.a.mobile);
    });
  ...
  Control_createClass(Control, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement("div", {
        ...
        className: this.withMobile(this.withShow(Control_default.a.pages)),
        style: {
          backgroundColor: backdrop
        }
...
var TOUCH_BEHAVIOR_BEGIN_THRESHOLD = 10;
var TOUCH_BEHAVIOR_END_THRESHOLD = 200;
...
var TOUCH_STYLE = function TOUCH_STYLE() {
  ...
  return {
    ...
    update: function update() {
      ...
      this.current = {
        ...
        origin: origin,
        offset: {
          x: origin.x - this.begin.origin.x,
          y: origin.y - this.begin.origin.y
        }
      }; // 更新行为属性

      if (!this.behavior) {
        var distanceX = Math.abs(this.current.offset.x);
        var distanceY = Math.abs(this.current.offset.y);
      ...
      var time = new Date().getTime(); // 更新阶段属性

      this.phase = TOUCH_BEHAVIOR_PHASE.END; // 更新行为属性
...
function (_React$PureComponent) {
  ...
  function Image(props, context) {
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "updateCurrentImageStyle", function () {
      var nextStyle = getCurrentImageStyle(_this.props, _this.context, _this.imageRef);
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "handleTouchStart", function (e) {
      ...
      _this.setTouchStyle(new TOUCH_STYLE({
        origin: {
          x: clientX,
          y: clientY
        }
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "handleTouchMove", function (e) {
      var touchStyle = _this.state.touchStyle;
      var _e$touches$2 = e.touches[0],
          clientX = _e$touches$2.clientX,
          clientY = _e$touches$2.clientY;

      _this.setTouchStyle(touchStyle.update({
        origin: {
          x: clientX,
          y: clientY
        }
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "handleTouchEnd", function (e) {
      ...
      _this.setTouchStyle(touchStyle.end());
    });
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "setTouchStyle", function (nextStyle) {
      _this.setState({
        touchStyle: Image_objectSpread({}, nextStyle)
      }, function () {
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "getStyle", function (step, distance, isSideImage) {
      var _this$context4 = _this.context,
          animate = _this$context4.animate,
      ...
      var _this$state = _this.state,
          ...
          touchStyle = _this$state.touchStyle; // 获取动画配置
      ...
      if (isSideImage) {
        transform = "translate3d(-50%, -50%, 0) translate3d(".concat(currentStyle.x + touch.x + offset, "px, ").concat(currentStyle.y, "px, 0px) scale3d(").concat(currentStyle.scale + overflow, ", ").concat(currentStyle.scale + overflow, ", 1) rotate3d(0, 0, 1, 0deg)");
        zIndex = 10 * distance;
        opacity = isFade || isCrossFade || isZoom ? 0 : 1;
        pointerEvents = 'none';
      } else {
        transform = "translate3d(-50%, -50%, 0) translate3d(".concat(currentStyle.x + touch.x, "px, ").concat(currentStyle.y + touch.y, "px, 0px) scale3d(").concat(currentStyle.scale, ", ").concat(currentStyle.scale, ", 1) rotate3d(0, 0, 1, ").concat(currentStyle.rotate, "deg)"); // clipPath = currentStyle.radius ? `inset(0% 0% 0% 0% round ${currentStyle.radius/currentStyle.scale}px)` : `inset(0% 0% 0% 0% round 0)`
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "buildImage", function (step) {
      ...
      var isSideImage = distance > 0; // 計算索引
  ...
  function Browser(props) {
    ...
    Browser_defineProperty(Browser_assertThisInitialized(_this), "init", function () {
      var _this$props = _this.props,
          ...
          coverVisible = _this$props.coverVisible,
          directZoom = _this$props.directZoom;
      var _this$state = _this.state,
    ...
    Browser_defineProperty(Browser_assertThisInitialized(_this), "unInit", function () {
      ...
      var _this$props2 = _this.props,
          ...
          coverVisible = _this$props2.coverVisible;
    ...
    Browser_defineProperty(Browser_assertThisInitialized(_this), "handleToggleZoom", function () {
      var onZooming = _this.props.onZooming; // direct zoomIn mode

      if (_this.props.directZoom && _this.state.zoom) {
        _this.props.outBrowsing();
      }
  ...
  Zmage_callee_createClass(ReactZmageCallee, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["className", "style", "onClick", "src", "alt", "txt", "set", "defaultPage", "preset", "controller", "hotKey", "animate", "zIndex", "backdrop", "radius", "edge", "loop", "directZoom", "onBrowsing", "onZooming", "onSwitching", "onRotating", "browsing"]);
      ...
      , {
        ...
        edge: edge,
        loop: loop,
        directZoom: directZoom // Life cycle functions
        ,
  ...
  Zmage_createClass(ReactZmage, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          onRotating = _this$props.onRotating,
          controlledBrowsing = _this$props.browsing,
          restProps = Zmage_objectWithoutProperties(_this$props, ["className", "style", "onClick", "forwardedRef", "src", "alt", "txt", "set", "defaultPage", "preset", "controller", "hotKey", "animate", "coverVisible", "backdrop", "zIndex", "radius", "edge", "loop", "directZoom", "onBrowsing", "onZooming", "onSwitching", "onRotating", "browsing"]);
      ...
      return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement("img", Zmage_extends({
        ...
        ref: function ref(_ref) {
          forwardedRef && (forwardedRef.current = _ref);
