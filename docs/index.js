      ...
      <div className={style.pageContainer}>
        ...
        <div className={style.page}>
          <a
            ...
            href="https://github.com/Caldis/react-zmage"
          >
          ...
          <div className={style.project}>
            ...
            <h1>react-zmage</h1>
            <h4>
              一个基于 React 的可缩放图片控件, 您可以用这个控件替代原生的 img
              标签, 令其附带图片缩放功能
            </h4>
            ...
            <div
              ...
              onClick={() =>
                window.open("https://github.com/Caldis/react-zmage")
              }
            >
              马上开始
            </div>
        ...
        <div className={style.horizon}>
          <div className={style.helpBox}>
            <h2>轻松使用</h2>
            <p>
              一如原生的 {"<img/>"} 标签, 只需要直接替换 img 为 Zmage 即可,
              您依旧可以使用 style, className 等原生属性
            </p>
            <p>
              现在, 点击图片, 您即可进入<b>查看模式</b>
            </p>
            <pre>
...
/>`}
          ...
          <div className={style.imageBox}>
            <Zmage
              ...
              alt="最简单的使用方式"
            />
            <a href="https://www.behance.net/gallery/56119387/_">
              via. sslololss Guihuahuzi on behance
            </a>
          </div>
        </div>
        ...
        <div className={style.horizon}>
          <div className={style.helpBox}>
            ...
            <p>
              在<b>放大模式</b>中, 图片会设置为 100%放大, 确保不会有任何失真
            </p>
            <p>
              再次点击屏幕即可退出<b>放大模式</b>
            </p>
...
/>`}
        ...
        <div className={style.horizon}>
          <div className={style.helpBox}>
            <h2>展示序列图片</h2>
            <p>
              您可以传入一系列图片来显示一系列幻灯片, 使用 <b>set</b> 来包裹它们
            </p>
            <p>
              点击放大后使用键盘的 <b>←</b> 或 <b>→</b> 即可切换图片
            </p>
            <pre>
              <PrismCode className="language-javascript">
                {`<Zmage
...
/>`}
        ...
        <div className={style.horizon}>
          <div className={style.helpBox}>
            ...
            <p>您可以使用键盘来快捷操作</p>
            <p>
              除了在展示序列图片时使用键盘的 <b>←</b> 或 <b>→</b> 来切换页面,
              你可以可以使用 <b>SPACE|空格键</b>, 来激活<b>放大模式</b>
            </p>
            <p>
              处于放大模式时, 点击 <b>退出|ESC</b> 可以退出<b>放大模式</b>,
              再次点击即可退出<b>查看模式</b>
            </p>
            <p>
              滚动页面同样也可以退出<b>查看模式</b>
            </p>
          </div>
          <div className={style.imageBox}>
            <Zmage
        ...
        <div className={style.horizon}>
          <div className={style.helpBox}>
            ...
            <p>
              ...
              <a
                onClick={() =>
                  Zmage.browsing({ src: "imgSet/childsDream/5.jpg" })
                }
              >
                任意元素
              </a>{" "}
              绑定一个事件， 以直接显示一个不存在的图片
            </p>
            <p>
              也可以使用{" "}
              <a
        ...
        <div className={style.horizon} style={{ display: "none" }}>
          <div className={style.helpBox}>
            ...
            <p>我们自带了两套默认配置项</p>
            <p>
              分别是 <b>桌面端(DESKTOP)</b> 以及 <b>移动端 (MOBILE)</b>
            </p>
        ...
        <div className={style.bottomBanner} style={{ textAlign: "center" }}>
          <div>
            ...
            <div
              className={style.button}
              onClick={() =>
                window.open("https://github.com/Caldis/react-zmage/issues")
              }
            >
              反馈建议
            </div>
